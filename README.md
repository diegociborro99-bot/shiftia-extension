...
sidepanel/index.html       ← UI del panel lateral
...
Toda la lógica usa el motor IA determinista de Shiftia (`scoreCandidate`, `isLegalAssignment`, `detectFragilePlantas`, `validateAssignment`, etc.). No hay llamadas a Claude/OpenAI/etc. en el flujo principal. Si en el futuro se decide añadir chat libre, irá detrás de un flag opcional.
